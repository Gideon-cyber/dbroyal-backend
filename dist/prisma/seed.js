...
async function main() {
    console.log(...oo_oo(`1473853625_17_2_17_39_4`, "🌱 Seeding database..."));
    await seedServices();
    ...
    if (existingManager) {
        console.log(...oo_oo(`1473853625_34_4_34_48_4`, "✓ Manager user already exists"));
        console.log(...oo_oo(`1473853625_35_4_35_52_4`, `  Email: ${existingManager.email}`));
        console.log(...oo_oo(`1473853625_36_4_36_50_4`, `  Name: ${existingManager.name}`));
        console.log(...oo_oo(`1473853625_37_4_37_50_4`, `  Role: ${existingManager.role}`));
        return;
    }
    ...
    console.log(...oo_oo(`1473853625_56_2_56_53_4`, "✓ Manager user created successfully!"));
    console.log(...oo_oo(`1473853625_57_2_57_42_4`, `  Email: ${manager.email}`));
    console.log(...oo_oo(`1473853625_58_2_58_40_4`, `  Name: ${manager.name}`));
    console.log(...oo_oo(`1473853625_59_2_59_40_4`, `  Role: ${manager.role}`));
    console.log(...oo_oo(`1473853625_60_2_60_40_4`, `  Password: ${password}`));
    console.log(...oo_oo(`1473853625_61_2_61_68_4`, "\n⚠️  Please change the password after first login!"));
}
async function seedServices() {
    console.log(...oo_oo(`1473853625_65_2_65_41_4`, "\n📋 Seeding services..."));
    const services = [
        {
    ...
    for (const serviceData of services) {
        ...
        let ngService;
        if (existingNG) {
            console.log(...oo_oo(`1473853625_380_6_380_70_4`, `  ✓ Service "${serviceInfo.title}" already exists`));
            ngService = existingNG;
        }
        else {
            ngService = await prisma.service.create({ data: serviceInfo });
            console.log(...oo_oo(`1473853625_384_6_384_62_4`, `  ✓ Created service: ${serviceInfo.title}`));
        }
        if (packages) {
            for (const packageData of packages) {
                ...
                if (existingPackage) {
                    console.log(...oo_oo(`1473853625_402_10_402_71_4`, `    ✓ Package "${pkgInfo.name}" already exists`));
                    continue;
                }
                await prisma.package.create({
                    data: {
                        ...
                        pricing: {
                            create: pricing.filter((p) => p.country === client_1.Country.NG),
                        },
                    },
                });
                console.log(...oo_oo(`1473853625_421_8_421_61_4`, `    ✓ Created package: ${pkgInfo.name}`));
            }
        }
        ...
        let ukService;
        if (existingUK) {
            console.log(...oo_oo(`1473853625_433_6_433_75_4`, `  ✓ Service "${serviceInfo.title} (UK)" already exists`));
            ...
            ukService = await prisma.service.create({
                data: {
                    ...serviceInfo,
                    slug: ukSlug,
                    country: client_1.Country.UK,
                },
            });
            console.log(...oo_oo(`1473853625_443_6_443_67_4`, `  ✓ Created service: ${serviceInfo.title} (UK)`));
        }
        if (packages) {
            for (const packageData of packages) {
                const { features, pricing, ...pkgInfo } = packageData;
                ...
                if (existingPackage) {
                    console.log(...oo_oo(`1473853625_461_10_461_76_4`, `    ✓ Package "${pkgInfo.name}" (UK) already exists`));
                    continue;
                }
                await prisma.package.create({
                    data: {
                        ...
                        pricing: {
                            create: pricing.filter((p) => p.country === client_1.Country.UK),
                        },
                    },
                });
                console.log(...oo_oo(`1473853625_480_8_480_66_4`, `    ✓ Created package: ${pkgInfo.name} (UK)`));
            }
        }
    }
}
async function migrateExistingEvents() {
    console.log(...oo_oo(`1473853625_487_2_487_50_4`, "\n🔄 Migrating existing events..."));
    try {
        const events = await prisma.$queryRaw `
      SELECT id, category, country FROM "Event" WHERE "serviceId" IS NULL
    `;
        if (events.length === 0) {
            console.log(...oo_oo(`1473853625_498_6_498_45_4`, "  ✓ No events to migrate"));
            return;
        }
        console.log(...oo_oo(`1473853625_502_4_502_61_4`, `  Found ${events.length} events to migrate`));
        for (const event of events) {
            ...
            if (!service) {
                console.log(...oo_oo(`1473853625_515_8_517_9_4`, `  ⚠️  Service not found for slug: ${fullSlug}, skipping event ${event.id}`));
                continue;
            }
            await prisma.$executeRaw `
        UPDATE "Event" SET "serviceId" = ${service.id} WHERE id = ${event.id}
      `;
            console.log(...oo_oo(`1473853625_524_6_526_7_4`, `  ✓ Migrated event ${event.id} from ${event.category} to ${service.title}`));
        }
    }
    catch (error) {
        console.log(...oo_oo(`1473853625_529_4_529_70_4`, "  ℹ️  Category column not found or already migrated"));
    }
}
main()
    .catch((e) => {
    console.error(...oo_tx(`1473853625_535_4_535_47_11`, "Error seeding database:", e));
    process.exit(1);
})
    .finally(async () => {
